...
const images = [];
const airpods = { //timeline에 사용할 객체 : 초기값 0
  frame: 0,
};

// Image 배열로 추출
const currentFrame = (index) => `https://www.apple.com/105/media/us/airpods-pro/2019/1299e2f5_9206_4470_b28e_08307a42f19b/anim/sequence/large/01-hero-lightpass/${(
  index + 1
)
  .toString()
  .padStart(4, '0')}.jpg`;
...
tl1
  ...
  .to(
    airpods,
    {
      duration: 8,
      frame: 140,
      snap: "frame", // frame을 snap으로 지정하면, frame이 정수로만 존재하도록 강제.
      ease: "none",
      onUpdate: () => {
